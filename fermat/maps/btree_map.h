...
namespace fermat {
    ...
    namespace container_internal {
        ...
        using map_params = typename fermat::base_internal::ApplyWithoutDefaultSuffix<
            map_params_impl,
            fermat::base_internal::TypeList<void, void, typename btree_map_defaults<Key, Data>::Compare,
            ...
            fermat::base_internal::TypeList<Key, Data, Compare, Alloc,
    ...
    namespace container_internal {
        ...
        struct map_params_impl
            : common_params<
                  Key,
                  fermat::base_internal::GetFromListOr<typename btree_map_defaults<Key, Data>::Compare, 0,
                      Params...>,
                  fermat::base_internal::GetFromListOr<typename btree_map_defaults<Key, Data>::Alloc, 1,
                      Params...>,
                  fermat::base_internal::GetFromListOr<typename btree_map_defaults<Key, Data>::TargetNodeSize,
                      2, Params...>::value,
            ...
            static_assert(
                std::is_same_v<
                    map_params<
                       ...
                       fermat::base_internal:: GetFromListOr<typename btree_map_defaults<Key, Data>::Alloc, 1,
                            Params...>,
                        fermat::base_internal::GetFromListOr<
