...
namespace fermat {
    ...
    namespace container_internal {
        ...
        template <typename Key, typename Compare, typename Alloc, int TargetNodeSize,
            bool IsMulti>
        using set_params = typename fermat::base_internal::ApplyWithoutDefaultSuffix<
            set_params_impl,
            fermat::base_internal::TypeList<void, typename btree_set_defaults<Key>::Compare,
            ...
            fermat::base_internal::TypeList<Key, Compare, Alloc, std::integral_constant<int, TargetNodeSize>,
    ...
    namespace container_internal {
        ...
        struct set_params_impl
            : common_params<
                  Key,
                  fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::Compare, 0,
                      Params...>,
                  fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::Alloc, 1, Params...>,
                  fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::TargetNodeSize, 2,
                      Params...>::value,
                  fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::IsMulti, 3,
                      Params...>::value,
            ...
            static_assert(
                std::is_same_v<
                    set_params<
                        ...
                        fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::Compare, 0,
                            Params...>,
                        fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::Alloc, 1,
                            Params...>,
                        fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::TargetNodeSize, 2,
                            Params...>::value,
                        fermat::base_internal::GetFromListOr<typename btree_set_defaults<Key>::IsMulti, 3,
