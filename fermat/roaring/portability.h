 ...
 * The library uses both FERMAT_ROARING_...
 * as well as CFERMAT_ROARING_ as prefixes. The FERMAT_ROARING_ prefix is for
 * macros that are provided by the build system or that are closely
 * related to the format. The header macros may also use FERMAT_ROARING_.
 * The CFERMAT_ROARING_ prefix is for internal macros that a user is unlikely
 * to ever interact with.
 */

#ifndef CFERMAT_ROARING_INCLUDE_PORTABILITY_H_
#define CFERMAT_ROARING_INCLUDE_PORTABILITY_H_
...
#ifdef _MSC_VER
#define CFERMAT_ROARING_VISUAL_STUDIO 1
/**
...
#define CFERMAT_ROARING_CLANG_VISUAL_STUDIO 1
#else
// just regular visual studio (best guess)
#define CFERMAT_ROARING_REGULAR_VISUAL_STUDIO 1
#endif  // __clang__
#endif  // _MSC_VER
#ifndef CFERMAT_ROARING_VISUAL_STUDIO
#define CFERMAT_ROARING_VISUAL_STUDIO 0
#endif
#ifndef CFERMAT_ROARING_CLANG_VISUAL_STUDIO
#define CFERMAT_ROARING_CLANG_VISUAL_STUDIO 0
#endif
#ifndef CFERMAT_ROARING_REGULAR_VISUAL_STUDIO
#define CFERMAT_ROARING_REGULAR_VISUAL_STUDIO 0
#endif
...
#if CFERMAT_ROARING_REGULAR_VISUAL_STUDIO
#ifndef __restrict__
#define __restrict__ __restrict
#endif  // __restrict__
#endif  // CFERMAT_ROARING_REGULAR_VISUAL_STUDIO

#if defined(__riscv) || defined(_M_RISCV32) || defined(_M_RISCV64)
#define CFERMAT_ROARING_IS_RISCV 1

#if (defined(__riscv_xlen) && (__riscv_xlen == 64)) || defined(_M_RISCV64)
#define CFERMAT_ROARING_IS_RISCV64 1
#endif

#elif defined(__x86_64__) || defined(_M_X64)
// we have an x64 processor
#define CFERMAT_ROARING_IS_X64 1

#if defined(_MSC_VER) && (_MSC_VER < 1910)
// Old visual studio systems won't support AVX2 well.
#undef CFERMAT_ROARING_IS_X64
#endif
...
#ifdef FERMAT_ROARING_DISABLE_X64
#undef CFERMAT_ROARING_IS_X64
#endif
...
#if CFERMAT_ROARING_CLANG_VISUAL_STUDIO
...
#if !defined(CFERMAT_ROARING_USENEON) && !defined(DISABLENEON) && defined(__ARM_NEON)
#define CFERMAT_ROARING_USENEON
#endif
#if defined(CFERMAT_ROARING_USENEON)
#include <arm_neon.h>
#endif

#if defined(__e2k__)
// we have an e2k (Elbrus-2000) processor
#define CFERMAT_ROARING_IS_E2K 1
#endif

#if !CFERMAT_ROARING_REGULAR_VISUAL_STUDIO && !defined(CFERMAT_ROARING_IS_E2K) && !__FILC__
/* Non-Microsoft C/C++-compatible compiler, assumes that it supports inline
 * assembly */
#define CFERMAT_ROARING_INLINE_ASM 1
#endif  // _MSC_VER
...
#define CFERMAT_ROARING_INTRINSICS 1
...
#ifndef CFERMAT_ROARING_INTRINSICS
#define CFERMAT_ROARING_INTRINSICS 1
...
#define CFERMAT_ROARING_WARN_UNUSED __attribute__((warn_unused_result))
#else
#define CFERMAT_ROARING_WARN_UNUSED
#endif

#define IS_BIG_ENDIAN (*(uint16_t *)"\0\xff" < 0x100)

#ifdef CFERMAT_ROARING_USENEON
// we can always compute the popcount fast.
#elif (defined(_M_ARM) || defined(_M_ARM64)) && \
    ((defined(_WIN64) || defined(_WIN32)) &&    \
     defined(CFERMAT_ROARING_REGULAR_VISUAL_STUDIO) && \
     CFERMAT_ROARING_REGULAR_VISUAL_STUDIO)
...
#if defined(_WIN64) && defined(CFERMAT_ROARING_REGULAR_VISUAL_STUDIO) && \
    CFERMAT_ROARING_REGULAR_VISUAL_STUDIO
#ifdef CFERMAT_ROARING_USENEON
...
#endif  // _M_ARM64
#elif defined(_WIN32) && defined(CFERMAT_ROARING_REGULAR_VISUAL_STUDIO) && \
    CFERMAT_ROARING_REGULAR_VISUAL_STUDIO
#ifdef _M_ARM
    return roaring_hamming_backup(x);
...
// CFERMAT_ROARING_BUILTIN_IMPLEMENTATION
//
...
// til 8.0 so CFERMAT_ROARING_TARGET_REGION and CFERMAT_ROARING_UNTARGET_REGION must be
// *outside* of a namespace.
#define CFERMAT_ROARING_TARGET_REGION(T)                                      \
    _Pragma(STRINGIFY(clang attribute push(__attribute__((target(T))), \
                                           apply_to = function)))
#define CFERMAT_ROARING_UNTARGET_REGION _Pragma("clang attribute pop")
#elif defined(__GNUC__)
// GCC is easier
#define CFERMAT_ROARING_TARGET_REGION(T) \
    _Pragma("GCC push_options") _Pragma(STRINGIFY(GCC target(T)))
#define CFERMAT_ROARING_UNTARGET_REGION _Pragma("GCC pop_options")
#endif  // clang then gcc

#endif  // CFERMAT_ROARING_IS_X64

// Default target region macros don't do anything.
#ifndef CFERMAT_ROARING_TARGET_REGION
#define CFERMAT_ROARING_TARGET_REGION(T)
#define CFERMAT_ROARING_UNTARGET_REGION
#endif

#define CFERMAT_ROARING_TARGET_AVX2 \
    CFERMAT_ROARING_TARGET_REGION("avx2,bmi,pclmul,lzcnt,popcnt")
#define CFERMAT_ROARING_TARGET_AVX512                                         \
    CFERMAT_ROARING_TARGET_REGION(                                            \
        "avx2,bmi,bmi2,pclmul,lzcnt,popcnt,avx512f,avx512dq,avx512bw," \
        "avx512vbmi2,avx512bitalg,avx512vpopcntdq")
#define CFERMAT_ROARING_UNTARGET_AVX2 CFERMAT_ROARING_UNTARGET_REGION
#define CFERMAT_ROARING_UNTARGET_AVX512 CFERMAT_ROARING_UNTARGET_REGION

#ifdef __AVX2__
// No need for runtime dispatching.
// It is unnecessary and harmful to old clang to tag regions.
#undef CFERMAT_ROARING_TARGET_AVX2
#define CFERMAT_ROARING_TARGET_AVX2
#undef CFERMAT_ROARING_UNTARGET_AVX2
#define CFERMAT_ROARING_UNTARGET_AVX2
#endif
...
// No need for runtime dispatching.
// It is unnecessary and harmful to old clang to tag regions.
#undef CFERMAT_ROARING_TARGET_AVX512
#define CFERMAT_ROARING_TARGET_AVX512
#undef CFERMAT_ROARING_UNTARGET_AVX512
#define CFERMAT_ROARING_UNTARGET_AVX512
#endif

// Allow unaligned memory access
#if defined(__GNUC__) || defined(__clang__)
#define CFERMAT_ROARING_ALLOW_UNALIGNED __attribute__((no_sanitize("alignment")))
#else
#define CFERMAT_ROARING_ALLOW_UNALIGNED
#endif

#if defined(__BYTE_ORDER__) && defined(__ORDER_BIG_ENDIAN__)
#define CFERMAT_ROARING_IS_BIG_ENDIAN (__BYTE_ORDER__ == __ORDER_BIG_ENDIAN__)
#elif defined(_WIN32)
#define CFERMAT_ROARING_IS_BIG_ENDIAN 0
#else
...
#define CFERMAT_ROARING_IS_BIG_ENDIAN 1
...
#elif defined(_WIN32) || defined(_WIN64)  // CFERMAT_ROARING_IS_BIG_ENDIAN
#include <stdlib.h>
#define croaring_htobe64(x) _byteswap_uint64(x)

#elif defined(__APPLE__)  // CFERMAT_ROARING_IS_BIG_ENDIAN
#include <libkern/OSByteOrder.h>
#define croaring_htobe64(x) OSSwapInt64(x)

#elif defined(__has_include) && \
    __has_include(              \
        <byteswap.h>)  && (defined(__linux__) || defined(__FreeBSD__))  // CFERMAT_ROARING_IS_BIG_ENDIAN
#include <byteswap.h>
...
#else  // CFERMAT_ROARING_IS_BIG_ENDIAN
...
#endif  // CFERMAT_ROARING_IS_BIG_ENDIAN
...
#define CFERMAT_ROARING_ATOMIC_IMPL_NONE 1
#define CFERMAT_ROARING_ATOMIC_IMPL_CPP 2
#define CFERMAT_ROARING_ATOMIC_IMPL_C 3
#define CFERMAT_ROARING_ATOMIC_IMPL_C_WINDOWS 4

// If the use has forced a specific implementation, use that, otherwise,
// figure out the best implementation we can use.
#if !defined(CFERMAT_ROARING_ATOMIC_IMPL)
#if defined(__cplusplus) && __cplusplus >= 201103L
#ifdef __has_include
#if __has_include(<atomic>)
#define CFERMAT_ROARING_ATOMIC_IMPL CFERMAT_ROARING_ATOMIC_IMPL_CPP
...
#define CFERMAT_ROARING_ATOMIC_IMPL CFERMAT_ROARING_ATOMIC_IMPL_C
#elif CFERMAT_ROARING_REGULAR_VISUAL_STUDIO
// https://www.technetworkhub.com/c11-atomics-in-visual-studio-2022-version-17/
#define CFERMAT_ROARING_ATOMIC_IMPL CFERMAT_ROARING_ATOMIC_IMPL_C_WINDOWS
#endif
#endif  // !defined(CFERMAT_ROARING_ATOMIC_IMPL)

#if CFERMAT_ROARING_ATOMIC_IMPL == CFERMAT_ROARING_ATOMIC_IMPL_C
#include <stdatomic.h>
...
#elif CFERMAT_ROARING_ATOMIC_IMPL == CFERMAT_ROARING_ATOMIC_IMPL_CPP
#include <atomic>
...
#elif CFERMAT_ROARING_ATOMIC_IMPL == CFERMAT_ROARING_ATOMIC_IMPL_C_WINDOWS
#include <intrin.h>
...
#elif CFERMAT_ROARING_ATOMIC_IMPL == CFERMAT_ROARING_ATOMIC_IMPL_NONE
#include <assert.h>
...
#if defined(__GNUC__) || defined(__clang__)
#define CFERMAT_ROARING_DEPRECATED __attribute__((deprecated))
#elif defined(_MSC_VER)
#define CFERMAT_ROARING_DEPRECATED __declspec(deprecated)
#else
#define CFERMAT_ROARING_DEPRECATED
#endif  // defined(__GNUC__) || defined(__clang__)

// We want to initialize structs to zero portably (C and C++), without
// warnings. We can do mystruct s = CFERMAT_ROARING_ZERO_INITIALIZER;
#if __cplusplus
#define CFERMAT_ROARING_ZERO_INITIALIZER \
    {}
#else
#define CFERMAT_ROARING_ZERO_INITIALIZER \
    { 0 }
...
#if defined(__cplusplus)
#define CFERMAT_ROARING_STATIC_ASSERT(x, y) static_assert(x, y)
#else
#define CFERMAT_ROARING_STATIC_ASSERT(x, y) _Static_assert(x, y)
#endif
...
// strict requirement.
#include <fermat/roaring/isadetection.h>  // include it last!
