 ...
 */
#ifndef INCLUDE_FERMAT_ROARING_ROARING64_HH_
#define INCLUDE_FERMAT_ROARING_ROARING64_HH_
...
class Roaring64 {
   ...
   public:
    ...
    Roaring64() : roaring(api::roaring64_bitmap_create()) {
        if (roaring == nullptr) {
            FERMAT_ROARING_TERMINATE("failed memory alloc in roaring64_bitmap_create");
        }
    }
    ...
    Roaring64(const Roaring64& r)
        ...
        if (roaring == nullptr) {
            FERMAT_ROARING_TERMINATE("failed roaring64_bitmap_copy in constructor");
        }
    }
    ...
    Roaring64& operator=(const Roaring64& r) {
        if (this != &r) {
            ...
            if (copy == nullptr) {
                FERMAT_ROARING_TERMINATE("failed roaring64_bitmap_copy in assignment");
            }
            if (roaring != nullptr) {
...
#endif  // INCLUDE_FERMAT_ROARING_ROARING64_HH_
