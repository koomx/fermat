 ...
 * library, the functions croaring_hardware_support() & FERMAT_ROARING_SUPPORTS_AVX512
 * and croaring_hardware_support() & FERMAT_ROARING_SUPPORTS_AVX2 *may* trigger an
 * additional call to dynamic_croaring_detect_supported_architectures().
 */
#ifndef CFERMAT_ROARING_INCLUDE_MISC_CONFIGREPORT_H_
#define CFERMAT_ROARING_INCLUDE_MISC_CONFIGREPORT_H_
...
static inline void native_cpuid(unsigned int *eax, unsigned int *ebx,
...
#ifdef CFERMAT_ROARING_INLINE_ASM
    ...
    (void)ecx;
    (void)edx;
#endif /* CFERMAT_ROARING_INLINE_ASM */
}
...
#elif defined(CFERMAT_ROARING_IS_RISCV64)
    printf("# RISC-V 64-bit processor detected\n");
#elif defined(CFERMAT_ROARING_IS_RISCV)
...
}  // extern "C" { namespace fermat::roaring { namespace misc {
#endif /* __cplusplus */

#endif /* CFERMAT_ROARING_INCLUDE_MISC_CONFIGREPORT_H_ */
