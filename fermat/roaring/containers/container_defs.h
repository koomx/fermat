 ...
 * the few API appearances use the macro FERMAT_ROARING_CONTAINER_T.  Those includes
 ...
 */
typedef FERMAT_ROARING_CONTAINER_T container_t;

/*
 * See FERMAT_ROARING_CONTAINER_T for notes on using container_t as a base class.
...
}  // namespace fermat::roaring { namespace internal {
#endif
