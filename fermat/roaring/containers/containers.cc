...
#define FERMAT_ROARING_INIT_FERMAT_ROARING_CONTAINER_ITERATOR_T roaring_container_iterator_t
...
roaring_container_iterator_t container_init_iterator(const container_t *c,
    ...
    switch (typecode) {
        case BITSET_CONTAINER_TYPE: {
            ...
            *value = index;
            return FERMAT_ROARING_INIT_FERMAT_ROARING_CONTAINER_ITERATOR_T{
                .index = index,
            };
        }
        case ARRAY_CONTAINER_TYPE: {
        ...
        default:
            assert(false);
            roaring_unreachable;
            return FERMAT_ROARING_INIT_FERMAT_ROARING_CONTAINER_ITERATOR_T{0};
    }
}
...
#undef FERMAT_ROARING_INIT_FERMAT_ROARING_CONTAINER_ITERATOR_T
