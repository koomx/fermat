...
#include <fermat/roaring/bitset_util.h>
#include <fermat/roaring/containers/array.h>
#include <fermat/roaring/containers/bitset.h>
#include <fermat/roaring/memory.h>
#include <fermat/roaring/portability.h>
#include <fermat/roaring/utilasm.h>

#if CFERMAT_ROARING_IS_X64
#ifndef CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
#error "CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512 needs to be defined."
#endif  // CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
#endif
...
bitset_container_t *bitset_container_create(void) {
    ...
    if (support & FERMAT_ROARING_SUPPORTS_AVX512) {
        // sizeof(__m512i) == 64
        align_size = 64;
    } else {
        // sizeof(__m256i) == 32
...
/* duplicate container. */
CFERMAT_ROARING_ALLOW_UNALIGNED
bitset_container_t *bitset_container_clone(const bitset_container_t *src) {
    ...
    size_t align_size = 32;
#if CFERMAT_ROARING_IS_X64
    if (croaring_hardware_support() & FERMAT_ROARING_SUPPORTS_AVX512) {
        // sizeof(__m512i) == 64
        align_size = 64;
    } else {
        // sizeof(__m256i) == 32
...
#if CFERMAT_ROARING_IS_X64
#ifndef CFERMAT_ROARING_WORDS_IN_AVX2_REG
#define CFERMAT_ROARING_WORDS_IN_AVX2_REG sizeof(__m256i) / sizeof(uint64_t)
#endif
...
int bitset_container_compute_cardinality(const bitset_container_t *bitset) {
    int support = croaring_hardware_support();
#if CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
    if (support & FERMAT_ROARING_SUPPORTS_AVX512) {
...
#endif  // CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
        if (support & FERMAT_ROARING_SUPPORTS_AVX2) {
            return (int)avx2_harley_seal_popcount256(
                (const __m256i *)bitset->words,
                BITSET_CONTAINER_SIZE_IN_WORDS / (CFERMAT_ROARING_WORDS_IN_AVX2_REG));
        } else {
            return _scalar_bitset_container_compute_cardinality(bitset);
        }
}

#elif defined(CFERMAT_ROARING_USENEON)
int bitset_container_compute_cardinality(const bitset_container_t *bitset) {
...
#define CFERMAT_ROARING_BITSET_CONTAINER_FN_REPEAT 8
#ifndef WORDS_IN_AVX512_REG
#define WORDS_IN_AVX512_REG sizeof(__m512i) / sizeof(uint64_t)
...
/* Computes a binary operation (eg union) on bitset1 and bitset2 and write the
   result to bitsetout */
// clang-format off
#define CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(before, opname, opsymbol, avx_intrinsic,   \
...
#define CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(before, opname, opsymbol, avx_intrinsic,           \
                                neon_intrinsic, after)                                 \
...
#define CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(before, opname, opsymbol, avx_intrinsic,            \
                                neon_intrinsic, after)                                  \
...
#if CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX512, or,    |, _mm512_or_si512, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX512, union, |, _mm512_or_si512, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX512, and,          &, _mm512_and_si512, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX512, intersection, &, _mm512_and_si512, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX512, xor,    ^,  _mm512_xor_si512,    veorq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX512, andnot, &~, _mm512_andnot_si512, vbicq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

// we duplicate the function because other containers use the "or" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX512, or,    |, _mm512_or_si512, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX512, union, |, _mm512_or_si512, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX512, and,          &, _mm512_and_si512, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX512, intersection, &, _mm512_and_si512, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX512, xor,    ^,  _mm512_xor_si512,    veorq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX512, andnot, &~, _mm512_andnot_si512, vbicq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

// we duplicate the function because other containers use the "or" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX512, or,    |, _mm512_or_si512, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX512, union, |, _mm512_or_si512, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX512, and,          &, _mm512_and_si512, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX512, intersection, &, _mm512_and_si512, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512

CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX512, xor,    ^,  _mm512_xor_si512,    veorq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
CFERMAT_ROARING_TARGET_AVX512
CFERMAT_ROARING_AVX512_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX512, andnot, &~, _mm512_andnot_si512, vbicq_u64, CFERMAT_ROARING_UNTARGET_AVX512)
CFERMAT_ROARING_UNTARGET_AVX512
#endif // CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512

#ifndef CFERMAT_ROARING_WORDS_IN_AVX2_REG
#define CFERMAT_ROARING_WORDS_IN_AVX2_REG sizeof(__m256i) / sizeof(uint64_t)
#endif // CFERMAT_ROARING_WORDS_IN_AVX2_REG
#define CFERMAT_ROARING_LOOP_SIZE                    \
    BITSET_CONTAINER_SIZE_IN_WORDS / \
        ((CFERMAT_ROARING_WORDS_IN_AVX2_REG)*CFERMAT_ROARING_BITSET_CONTAINER_FN_REPEAT)

/* Computes a binary operation (eg union) on bitset1 and bitset2 and write the
   result to bitsetout */
// clang-format off
#define CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(before, opname, opsymbol, avx_intrinsic,               \
                                neon_intrinsic, after)                                \
  static inline int _avx2_bitset_container_##opname##_nocard(                                \
    ...
    const int innerloop = 8;                                                   \
    for (size_t i = 0;                                                         \
         i < BITSET_CONTAINER_SIZE_IN_WORDS / (CFERMAT_ROARING_WORDS_IN_AVX2_REG);             \
         i += innerloop) {                                                     \
      __m256i A1, A2, AO;                                                      \
...
#define CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(before, opname, opsymbol, avx_intrinsic,               \
                                neon_intrinsic, after)                                \
  /* next, a version that updates cardinality*/                                \
...
#define CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(before, opname, opsymbol, avx_intrinsic,               \
                                neon_intrinsic, after)                                \
  /* next, a version that just computes the cardinality*/                      \
  static inline int _avx2_bitset_container_##opname##_justcard(                              \
    ...
    return (int)avx2_harley_seal_popcount256_##opname(                         \
        data2, data1, BITSET_CONTAINER_SIZE_IN_WORDS / (CFERMAT_ROARING_WORDS_IN_AVX2_REG));   \
  }


// we duplicate the function because other containers use the "or" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX2, or,    |, _mm256_or_si256, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX2, union, |, _mm256_or_si256, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX2, and,          &, _mm256_and_si256, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX2, intersection, &, _mm256_and_si256, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX2, xor,    ^,  _mm256_xor_si256,    veorq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN1(CFERMAT_ROARING_TARGET_AVX2, andnot, &~, _mm256_andnot_si256, vbicq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

// we duplicate the function because other containers use the "or" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX2, or,    |, _mm256_or_si256, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX2, union, |, _mm256_or_si256, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX2, and,          &, _mm256_and_si256, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX2, intersection, &, _mm256_and_si256, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX2, xor,    ^,  _mm256_xor_si256,    veorq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN2(CFERMAT_ROARING_TARGET_AVX2, andnot, &~, _mm256_andnot_si256, vbicq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

// we duplicate the function because other containers use the "or" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX2, or,    |, _mm256_or_si256, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX2, union, |, _mm256_or_si256, vorrq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX2, and,          &, _mm256_and_si256, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX2, intersection, &, _mm256_and_si256, vandq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2

CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX2, xor,    ^,  _mm256_xor_si256,    veorq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
CFERMAT_ROARING_TARGET_AVX2
CFERMAT_ROARING_AVX_BITSET_CONTAINER_FN3(CFERMAT_ROARING_TARGET_AVX2, andnot, &~, _mm256_andnot_si256, vbicq_u64, CFERMAT_ROARING_UNTARGET_AVX2)
CFERMAT_ROARING_UNTARGET_AVX2
...
#if CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
#define CFERMAT_ROARING_BITSET_CONTAINER_FN(opname, opsymbol, avx_intrinsic, neon_intrinsic)   \
  int bitset_container_##opname(const bitset_container_t *src_1,               \
    ...
    else if ( support & FERMAT_ROARING_SUPPORTS_AVX2 ) {                              \
...
#else // CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
...
#define CFERMAT_ROARING_BITSET_CONTAINER_FN(opname, opsymbol, avx_intrinsic, neon_intrinsic)   \
  int bitset_container_##opname(const bitset_container_t *src_1,               \
                                const bitset_container_t *src_2,               \
                                bitset_container_t *dst) {                     \
    if ( croaring_hardware_support() & FERMAT_ROARING_SUPPORTS_AVX2 ) {               \
      return _avx2_bitset_container_##opname(src_1, src_2, dst);               \
    } else {                                                                   \
      return _scalar_bitset_container_##opname(src_1, src_2, dst);             \
    }                                                                          \
...
// we duplicate the function because other containers use the "or" term, makes API more consistent
CFERMAT_ROARING_BITSET_CONTAINER_FN(or,    |, _mm256_or_si256, vorrq_u64)
CFERMAT_ROARING_BITSET_CONTAINER_FN(union, |, _mm256_or_si256, vorrq_u64)

// we duplicate the function because other containers use the "intersection" term, makes API more consistent
CFERMAT_ROARING_BITSET_CONTAINER_FN(and,          &, _mm256_and_si256, vandq_u64)
CFERMAT_ROARING_BITSET_CONTAINER_FN(intersection, &, _mm256_and_si256, vandq_u64)

CFERMAT_ROARING_BITSET_CONTAINER_FN(xor,    ^,  _mm256_xor_si256,    veorq_u64)
CFERMAT_ROARING_BITSET_CONTAINER_FN(andnot, &~, _mm256_andnot_si256, vbicq_u64)
// clang-format On
...
int bitset_container_to_uint32_array(
   ...
   int support = croaring_hardware_support();
#if CFERMAT_ROARING_COMPILER_SUPPORTS_AVX512
   if(( support & FERMAT_ROARING_SUPPORTS_AVX512 ) &&  (bc->cardinality >= 8192))  // heuristic
		return (int) bitset_extract_setbits_avx512(bc->words,
                BITSET_CONTAINER_SIZE_IN_WORDS, out, bc->cardinality, base);
   else
#endif
   if(( support & FERMAT_ROARING_SUPPORTS_AVX2 ) &&  (bc->cardinality >= 8192))  // heuristic
...
int32_t bitset_container_write(const bitset_container_t *container,
                                  char *buf) {
#if CFERMAT_ROARING_IS_BIG_ENDIAN
