...
#ifndef FERMAT_ROARING_H
#define FERMAT_ROARING_H

#include <stdbool.h>
#include <stddef.h>  // for `size_t`
#include <stdint.h>

#include <fermat/roaring/roaring_types.h>
...
#include <fermat/roaring/roaring_version.h>
...
inline bool roaring_bitmap_get_copy_on_write(const roaring_bitmap_t *r) {
    return r->high_low_container.flags & FERMAT_ROARING_FLAG_COW;
}
inline void roaring_bitmap_set_copy_on_write(roaring_bitmap_t *r, bool cow) {
    if (cow) {
        r->high_low_container.flags |= FERMAT_ROARING_FLAG_COW;
    } else {
 ...
 */
CFERMAT_ROARING_DEPRECATED roaring_bitmap_t *roaring_bitmap_of(size_t n, ...);
...
typedef struct roaring_bulk_context_s {
    FERMAT_ROARING_CONTAINER_T *container;
    int idx;
    uint16_t key;
    uint8_t typecode;
...
typedef struct roaring_uint32_iterator_s {
    ...
    const FERMAT_ROARING_CONTAINER_T *container;  // Current container
...
CFERMAT_ROARING_DEPRECATED static inline void roaring_init_iterator(
...
CFERMAT_ROARING_DEPRECATED static inline void roaring_init_iterator_last(
    const roaring_bitmap_t *r, roaring_uint32_iterator_t *newit) {
...
CFERMAT_ROARING_DEPRECATED static inline roaring_uint32_iterator_t *
...
CFERMAT_ROARING_DEPRECATED static inline bool roaring_advance_uint32_iterator(
...
CFERMAT_ROARING_DEPRECATED static inline bool roaring_previous_uint32_iterator(
    roaring_uint32_iterator_t *it) {
...
CFERMAT_ROARING_DEPRECATED static inline bool
...
CFERMAT_ROARING_DEPRECATED static inline void roaring_free_uint32_iterator(
    roaring_uint32_iterator_t *it) {
...
CFERMAT_ROARING_DEPRECATED static inline uint32_t roaring_read_uint32_iterator(
...
}  // extern "C" { namespace fermat::roaring { namespace api {
#endif

#endif /* FERMAT_ROARING_H */
 ...
 */
#if !defined(FERMAT_ROARING_API_NOT_IN_GLOBAL_NAMESPACE)
using namespace ::fermat::roaring::api;
#endif
#endif
