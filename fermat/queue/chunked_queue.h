...
#include <fermat/queue/internal/chunked_queue.h>
...
namespace fermat {
    ...
    private:
        ...
        private:
            explicit basic_iterator(Block* b)
                : iterator_common(b) { }
    ...
    public:
        ...
        template <typename Iter,
            typename = std::enable_if_t<
                turbo::meta_internal::IsAtLeastInputIterator<Iter>::value>>
        ...
        chunked_queue& operator=(const chunked_queue& other) {
            ...
            if (AllocatorTraits::propagate_on_container_copy_assignment::value && (alloc_and_size_.allocator() != other.alloc_and_size_.allocator())) {
        ...
        void assign(Iter first, Iter last) {
            ...
            if (!empty() && out.block != nullptr && out.ptr == out.block->start() && prev_block != nullptr) {
        ...
        void swap(chunked_queue& other) noexcept {
            ...
            if (AllocatorTraits::propagate_on_container_swap::value) {
                ...
                turbo::base_internal::HardeningAssert(get_allocator() == other.get_allocator());
