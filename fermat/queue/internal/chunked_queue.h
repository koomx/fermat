...
namespace fermat {
    ...
    namespace container_internal {
        ...
        public:
            ...
            T* start() {
                return reinterpret_cast<T*>(reinterpret_cast<uintptr_t>(this) + start_offset());
            }
        ...
        private:
            ...
            static constexpr size_t AllocSize(size_t min_element_count) {
                return fermat::base_internal::Layout<ChunkedQueueBlock, T>(
                    1, min_element_count)
                    .AllocSize();
            }

            static constexpr ptrdiff_t start_offset() {
                return fermat::base_internal::Layout<ChunkedQueueBlock, T>(1, 1)
                    .template Offset<1>();
            }
