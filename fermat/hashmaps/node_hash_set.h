...
namespace fermat {
    ...
    class KUMO_ATTRIBUTE_OWNER node_hash_set
        : public fermat::container_internal::InstantiateRawHashSet<
              fermat::container_internal::NodeHashSetPolicy<T>, Hash, Eq,
              Alloc>::type {
    ...
    namespace container_internal {
        ...
        template <class T>
        struct NodeHashSetPolicy
            : fermat::container_internal::node_slot_policy<T&, NodeHashSetPolicy<T>> {
            using key_type = T;
            using init_type = T;
...
namespace turbo::container_algorithm_internal {
    ...
    struct IsUnorderedContainer<fermat::node_hash_set<Key, Hash, KeyEqual, Allocator>>
        : std::true_type { };
