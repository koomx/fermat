...
// -----------------------------------------------------------------------------
//
// An `fermat::node_hash_map<K, V>` is an unordered associative container of
...
namespace fermat {
    ...
    // -----------------------------------------------------------------------------
    // fermat::node_hash_map
    // -----------------------------------------------------------------------------
    //
    // An `fermat::node_hash_map<K, V>` is an unordered associative container which
    ...
    // types.
    //
    // Using `fermat::node_hash_map` at interface boundaries in dynamically loaded
    ...
    //   fermat::node_hash_map<std::string, std::string> ducks =
    ...
    class KUMO_ATTRIBUTE_OWNER node_hash_map
        : public fermat::container_internal::InstantiateRawHashMap<
              fermat::container_internal::NodeHashMapPolicy<Key, Value>, Hash, Eq,
              Alloc>::type {
    ...
    public:
        ...
        //    fermat::node_hash_map<int, std::string> map1;
        //
        // * Initializer List constructor
        //
        //   fermat::node_hash_map<int, std::string> map2 =
        //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
        //
        // * Copy constructor
        //
        //   fermat::node_hash_map<int, std::string> map3(map2);
        //
        // * Copy assignment operator
        //
        //   // Hash functor and Comparator are copied as well
        //   fermat::node_hash_map<int, std::string> map4;
        //   map4 = map3;
        //
        // * Move constructor
        //
        //   // Move is guaranteed efficient
        //   fermat::node_hash_map<int, std::string> map5(std::move(map4));
        //
        ...
        //   fermat::node_hash_map<int, std::string> map6;
        //   map6 = std::move(map5);
        //
        ...
        //   fermat::node_hash_map<int, std::string> map7(v.begin(), v.end());
        //
        // * from_range constructor (C++23)
        //
        //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
        //   fermat::node_hash_map<int, std::string> map8(std::from_range, v);
        node_hash_map() { }
        using Base::Base;
        ...
        //
        // NOTE: this member function is particular to `fermat::node_hash_map` and is
    ...
    namespace container_internal {
        ...
        template <class Key, class Value>
        class NodeHashMapPolicy
            : public fermat::container_internal::node_slot_policy<
...
namespace turbo::container_algorithm_internal {
    ...
    struct IsUnorderedContainer<
        fermat::node_hash_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type { };
