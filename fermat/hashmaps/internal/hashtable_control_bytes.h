...
#define FERMAT_SWISSTABLE_ASSERT(CONDITION) \
    assert((CONDITION) && "Try enabling sanitizers.")
        ...
        uint32_t TrailingZeros(T x) {
            KUMO_ASSUME(x != 0);
            return static_cast<uint32_t>(turbo::countr_zero(x));
        }
        ...
        public:
            ...
            uint32_t LeadingZeros() const {
                ...
                return static_cast<uint32_t>(
                           turbo::countl_zero(static_cast<T>(mask_ << extra_bits)))
                    >> Shift;
            }
        ...
        public:
            explicit BitMask(T mask)
                ...
                if (Shift == 3 && !NullifyBitsOnIteration) {
                    FERMAT_SWISSTABLE_ASSERT(this->mask_ == (this->mask_ & kMsbs8Bytes));
                }
            }
        ...
        static_assert(
            (static_cast<int8_t>(ctrl_t::kEmpty) & static_cast<int8_t>(ctrl_t::kDeleted) & static_cast<int8_t>(ctrl_t::kSentinel) & 0x80) != 0,
        ...
        static_assert(
            (~static_cast<int8_t>(ctrl_t::kEmpty) & ~static_cast<int8_t>(ctrl_t::kDeleted) & static_cast<int8_t>(ctrl_t::kSentinel) & 0x7F) != 0,
        ...
        struct GroupAArch64Impl {
            ...
            using NonIterableBitMaskType = NonIterableBitMask<uint64_t, kWidth, /*Shift=*/3>;
            ...
            auto MaskEmpty() const {
                uint64_t mask = vget_lane_u64(vreinterpret_u64_u8(vceq_s8(
            ...
            auto MaskEmptyOrDeleted() const {
                uint64_t mask = vget_lane_u64(vreinterpret_u64_u8(vcgt_s8(
            ...
            void ConvertSpecialToEmptyAndFullToDeleted(ctrl_t* dst) const {
                ...
                turbo::little_endian::Store64(dst, res);
            }
        ...
        struct GroupPortableImpl {
            ...
            explicit GroupPortableImpl(const ctrl_t* pos)
                : ctrl(turbo::little_endian::Load64(pos)) { }
