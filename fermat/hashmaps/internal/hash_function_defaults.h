...
namespace fermat::container_internal {
        ...
        struct HashEq<T, typename std::enable_if_t<HasTurboContainerHash<T>::value>> {
            ...
            static_assert(fermat::base_internal::IsTransparent<Hash>::value,
                "turbo_container_hash must be transparent. To achieve it add a "
                "`using is_transparent = void;` clause to this type.");
            static_assert(fermat::base_internal::IsTransparent<Eq>::value,
        ...
        //
        // Example: typename Hash = typename fermat::flat_hash_map<K, V>::hasher
        template <class T>
        ...
        //
        // Example: typename Eq = typename fermat::flat_hash_map<K, V, Hash>::key_equal
        template <class T>
