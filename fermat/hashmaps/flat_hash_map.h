...
// -----------------------------------------------------------------------------
//
// An `fermat::flat_hash_map<K, V>` is an unordered associative container of
...
namespace fermat {
    ...
    // -----------------------------------------------------------------------------
    // fermat::flat_hash_map
    // -----------------------------------------------------------------------------
    //
    // An `fermat::flat_hash_map<K, V>` is an unordered associative container which
    ...
    // types.
    //
    // Using `fermat::flat_hash_map` at interface boundaries in dynamically loaded
    ...
    // consider using `fermat::flat_hash_map<Key, std::unique_ptr<Value>>` instead.
    // If your types are not moveable or you require pointer stability for keys,
    // consider `fermat::node_hash_map`.
    //
    ...
    //   fermat::flat_hash_map<std::string, std::string> ducks =
    ...
    class KUMO_ATTRIBUTE_OWNER flat_hash_map
        : public fermat::container_internal::InstantiateRawHashMap<
              fermat::container_internal::FlatHashMapPolicy<K, V>, Hash, Eq,
              Allocator>::type {
    ...
    public:
        ...
        //    fermat::flat_hash_map<int, std::string> map1;
        //
        // * Initializer List constructor
        //
        //   fermat::flat_hash_map<int, std::string> map2 =
        //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
        //
        // * Copy constructor
        //
        //   fermat::flat_hash_map<int, std::string> map3(map2);
        //
        // * Copy assignment operator
        //
        //   // Hash functor and Comparator are copied as well
        //   fermat::flat_hash_map<int, std::string> map4;
        //   map4 = map3;
        //
        // * Move constructor
        //
        //   // Move is guaranteed efficient
        //   fermat::flat_hash_map<int, std::string> map5(std::move(map4));
        //
        ...
        //   fermat::flat_hash_map<int, std::string> map6;
        //   map6 = std::move(map5);
        //
        ...
        //   fermat::flat_hash_map<int, std::string> map7(v.begin(), v.end());
        //
        // * from_range constructor (C++23)
        //
        //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
        //   fermat::flat_hash_map<int, std::string> map8(std::from_range, v);
        flat_hash_map() { }
        using Base::Base;
        ...
        //
        // NOTE: this member function is particular to `fermat::flat_hash_map` and is
...
namespace turbo::container_algorithm_internal {
    ...
    struct IsUnorderedContainer<
        fermat::flat_hash_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type { };
