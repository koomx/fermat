...
// -----------------------------------------------------------------------------
//
// An `fermat::flat_hash_set<T>` is an unordered associative container designed to
...
namespace fermat {
    ...
    // -----------------------------------------------------------------------------
    // fermat::flat_hash_set
    // -----------------------------------------------------------------------------
    //
    // An `fermat::flat_hash_set<T>` is an unordered associative container which has
    ...
    // types.
    //
    // Using `fermat::flat_hash_set` at interface boundaries in dynamically loaded
    ...
    // `fermat::flat_hash_set<std::unique_ptr<T>>`. If your type is not moveable and
    ...
    //   fermat::flat_hash_set<std::string> ducks =
    //     {"huey", "dewey", "louie"};
    //
    ...
    class KUMO_ATTRIBUTE_OWNER flat_hash_set
        : public fermat::container_internal::InstantiateRawHashSet<
              fermat::container_internal::FlatHashSetPolicy<T>, Hash, Eq,
              Allocator>::type {
    ...
    public:
        ...
        //    fermat::flat_hash_set<std::string> set1;
        //
        // * Initializer List constructor
        //
        //   fermat::flat_hash_set<std::string> set2 =
        //       {{"huey"}, {"dewey"}, {"louie"},};
        //
        // * Copy constructor
        //
        //   fermat::flat_hash_set<std::string> set3(set2);
        //
        // * Copy assignment operator
        //
        //   // Hash functor and Comparator are copied as well
        //   fermat::flat_hash_set<std::string> set4;
        //   set4 = set3;
        //
        // * Move constructor
        //
        //   // Move is guaranteed efficient
        //   fermat::flat_hash_set<std::string> set5(std::move(set4));
        //
        ...
        //   fermat::flat_hash_set<std::string> set6;
        //   set6 = std::move(set5);
        //
        ...
        //   fermat::flat_hash_set<std::string> set7(v.begin(), v.end());
        //
        // * from_range constructor (C++23)
        //
        //   std::vector<std::string> v = {"a", "b"};
        //   fermat::flat_hash_set<std::string> set8(std::from_range, v);
        flat_hash_set() { }
        using Base::Base;
        ...
        //
        // NOTE: this member function is particular to `fermat::flat_hash_set` and is
...
namespace turbo::container_algorithm_internal {
    ...
    struct IsUnorderedContainer<fermat::flat_hash_set<Key, Hash, KeyEqual, Allocator>>
        : std::true_type { };
