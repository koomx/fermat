...
#include <fermat/roaring/containers/mixed_andnot.h>
#include <fermat/roaring/containers/mixed_intersection.h>
#include <fermat/roaring/containers/mixed_negation.h>
#include <fermat/roaring/containers/mixed_union.h>
#include <fermat/roaring/containers/mixed_xor.h>
...
#define FERMAT_ROARING_TEST_SUITE MixedContainer
#include "test.h"
    ...
    for (int x = 0; x < (1 << 16) - start_offset; x++) {
        ...
        if (x % k == 0) {
            ...
            run_container_append_first(
                RI, CFERMAT_ROARING_MAKE_RLE16(offsetx, actual_runlen - 1));
...
#define CFERMAT_ROARING_SLOW_NEGATION_RANGE_TESTS 0

#if CFERMAT_ROARING_SLOW_NEGATION_RANGE_TESTS
...
#endif  // CFERMAT_ROARING_SLOW_NEGATION_RANGE_TESTS
