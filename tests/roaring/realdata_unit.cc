...
#include <fermat/roaring/array_util.h>  // union_uint32(), intersection_uint32()
#include <fermat/roaring/misc/configreport.h>
#include <fermat/roaring/roaring.h>  // public api
...
#include "config.h"
#define FERMAT_ROARING_TEST_SUITE Realdata
#include "test.h"
