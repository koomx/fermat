    ...
    namespace container_internal {
        namespace {
            ...
            public:
                ...
                using propagate_on_container_copy_assignment = std::bool_constant<(Spec & kPropagateOnCopy) != 0>;

                using propagate_on_container_move_assignment = std::bool_constant<(Spec & kPropagateOnMove) != 0>;

                using propagate_on_container_swap = std::bool_constant<(Spec & kPropagateOnSwap) != 0>;
            ...
            struct Policy {
                using slot_type = fermat::base_internal::Tracked<int32_t>;
                using init_type = fermat::base_internal::Tracked<int32_t>;
            ...
            struct PropagateTest : public ::testing::Test {
                using Alloc = CheckedAlloc<fermat::base_internal::Tracked<int32_t>, Spec>;
