...
#include <tests/hashmaps/internal/heterogeneous_lookup_testing.h>
#include <string_view>
...
class CopyableMovableType
    : public fermat::test_internal::CopyableMovableInstance {
 public:
...
TEST(LinkedHashMapTest, RValueOperatorAt) {
  fermat::test_internal::InstanceTracker tracker;
...
TEST(LinkedHashMap, ExtractAndEmplaceUseSameStatefulAllocator) {
  using Alloc =
      fermat::container_internal::CountingAllocator<std::pair<const int, int>>;
