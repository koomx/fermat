    ...
    namespace container_internal {
        namespace {
            ...
            void BM_OffsetConstantStatic(benchmark::State& state) {
                using L = typename fermat::base_internal::Layout<Ts...>::template WithStaticSizes<3, 5, 7>;
            ...
            void BM_OffsetConstant(benchmark::State& state) {
                using L = fermat::base_internal::Layout<Ts...>;
            ...
            void BM_OffsetPartialStatic(benchmark::State& state) {
                using L = typename fermat::base_internal::Layout<Ts...>::template WithStaticSizes<3, 5>;
                size_t k = 7;
            ...
            size_t AllocSize<int8_t, int16_t, int32_t, Int128>(size_t x) {
                constexpr size_t o = fermat::base_internal::Layout<int8_t, int16_t, int32_t, Int128>::Partial(3, 5, 7)
            ...
            size_t AllocSize<Int128, int32_t, int16_t, int8_t>(size_t x) {
                constexpr size_t o = fermat::base_internal::Layout<Int128, int32_t, int16_t, int8_t>::Partial(3, 5, 7)
